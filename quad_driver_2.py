...
class quad_driver_2(UnitConversion):
    base_unit = 'V'
    derived_units = ['A', 'Gcm']
    
    def __init__(self,calibration_parameters = {'A_per_V':-40, 'Gcm_per_A':1.88679, 'A_offset':0, 'A_min':0}):  #{'A_per_V':19.9757, 'Gcm_per_A':1.88679, 'A_offset':-0.642724, 'A_min':-0.09}):            
        self.parameters = calibration_parameters
     
        self.parameters.setdefault('A_per_V',-12)
        self.parameters.setdefault('Gcm_per_A',1.88679)
        self.parameters.setdefault('A_offset',0)
        self.parameters.setdefault('A_min',0)
